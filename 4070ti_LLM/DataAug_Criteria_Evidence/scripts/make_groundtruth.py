...
def main():
    ...
    parser.add_argument(
        "--random-seed", type=int, default=42, help="Random seed for splits"
    )
    parser.add_argument(
        "--skip-validation",
        action="store_true",
    ...
    print("Loaded field mapping configuration")
    ...
    if len(evidence_gt) > 0:
        print("  Evidence spans per criterion:")
