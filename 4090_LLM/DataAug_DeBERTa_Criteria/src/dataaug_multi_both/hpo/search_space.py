...
class SearchSpaceConfig:
    ...
    # Model hyperparameters (fixed model)
    model_name: str = "microsoft/deberta-v3-base"  # fixed model
...
class OptunaSearchSpace:
    ...
    def suggest_hyperparameters(self, trial: 'optuna.Trial') -> Dict[str, Any]:
        ...
        # Model selection (fixed to microsoft/deberta-v3-base)
        params["model_name"] = "microsoft/deberta-v3-base"
    ...
    def validate_params(self, params: Dict[str, Any]) -> bool:
        ...
        """
        # Check required parameters (model_name is now fixed)
        required = [
