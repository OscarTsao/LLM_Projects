...
### T001: Initialize Project Structure [BLOCKING]
...
### T002: Set Up Poetry Dependency Management [BLOCKING] [P]
...
### T003: Create Makefile [BLOCKING] [P]
**Files**: `Makefile`  
...
### T004: Set Up Hydra Configuration Framework [BLOCKING] [P]
...
### T005: Implement Exponential Backoff Retry Utility [BLOCKING] [P]
...
### T006: Implement Dual Logging System [BLOCKING] [P]
...
### T007: Implement Storage Monitoring Background Thread [BLOCKING] [P]
...
### T008: Create Contract Validation Test Framework [P]
...
### T009: Implement Data Loading & Preprocessing [BLOCKING]
...
### T010: Implement TextAttack Data Augmentation [P]
...
### T011: Implement Hugging Face Model Encoder Wrapper [BLOCKING] [P]
...
### T012: [REMOVED] Criteria Matching Heads
This repository has migrated to single-agent (evidence binding). Criteria classification components are removed in v2.0.

---

### T013: Implement Evidence Binding Heads [BLOCKING] [P]
...
### T014: [REMOVED] Multi-Task Model Architecture
This repository has migrated to single-agent (evidence binding). Multi-task coupling is removed in v2.0.

---

### T015: Implement Loss Functions [BLOCKING] [P]
...
### T016: Implement Checkpoint Manager with Integrity Validation [BLOCKING]
...
### T017: Implement MLflow Metrics Buffering [BLOCKING] [P]
...
### T018: Implement Optuna Search Space Definition [BLOCKING] [P]
...
### T019: [US1] Implement Training Loop with Epoch-Based Checkpointing
...
### T020: [US1] Implement Sequential Trial Executor [P]
...
### T021: [US1] Implement Resume from Latest Checkpoint
...
### T022: [US1] Implement Proactive Retention Pruning
...
### T023: [US1] Implement CLI Entry Point for Training
...
- Compute evidence binding metrics: exact_match, span_F1, precision, recall, char_F1, null_span_accuracy
...
- Include test_metrics (evidence_binding only)
...
- Verify evidence metrics structure
...
- III. Single-Agent Architecture: Verify evidence binding functional
...
- T010 (Augmentation), T011 (Encoder), T013 (Evidence Heads), T015 (Losses), T017 (Metrics Buffer), T018 (Search Space)
- T014 (Multi-Task Model) [REMOVED in v2.0]
