...
class TextAugmenter:
    ...
    def __init__(self, config: AugmentationConfig):
        ...
        try:
            if config.method == "synonym":
                ...
                self.augmenter = EmbeddingAugmenter(transformations_per_example=1)
                ...
                self.augmenter = EasyDataAugmenter(transformations_per_example=1)
    ...
    def augment_evidence(
        self, text: str, evidence_spans: list[tuple[int, int]] | None = None
...
def create_augmenter(method: str = "synonym", probability: float = 0.3, **kwargs) -> TextAugmenter:
    ...
    """
    config = AugmentationConfig(method=method, probability=probability, **kwargs)
