...
def sample_annotations():
    """Create sample annotations DataFrame with sufficient samples for splitting."""
    return pd.DataFrame(
        {
            "post_id": [
                "post1",
            ...
            "criterion_id": ["A", "B", "A", "C", "A", "B", "C", "A", "B", "C", "A"],
            "status": [
                "positive",
                "negative",
                "1",
            ...
            "cases": [
                ...
                [],
                '[{"text": "evidence3", "start_char": 0, "end_char": 9}]',
                "[]",
                '[{"text": "evidence4", "start_char": 5, "end_char": 14}]',
                [],
                '[{"text": "evidence5", "start_char": 0, "end_char": 9}]',
                "[]",
                '[{"text": "evidence6", "start_char": 5, "end_char": 14}]',
            ],
        }
    )
...
def test_create_criteria_groundtruth(
    ...
    # Check values
    assert len(criteria_gt) == 11  # All annotations should be included
