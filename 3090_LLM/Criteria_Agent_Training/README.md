...
```bash
# Basic classifier (recommended for most users)
python scripts/final_training.py

# SpanBERT with advanced features
python scripts/train_and_evaluate.py

# Hydra-enabled training with configuration management
python scripts/hydra_trainer.py
...
├── src/                               # Source code
│   ├── models/                        # ML models
│   │   ├── basic_classifier.py       # Main neural network classifier
│   │   └── spanbert_classifier.py    # Advanced SpanBERT implementation
│   └── utils/                         # Utility functions
│       └── training_utils.py         # Common training utilities
│
├── scripts/                           # Executable scripts
│   ├── train_and_evaluate.py         # Main training script (SpanBERT)
│   ├── hydra_trainer.py             # Hydra-enabled training
│   ├── final_training.py            # Optimized training (Basic model)
...
│   ├── test_enhanced_metrics.py     # Metrics testing
│   └── test_hydra_config.py         # Configuration tests
│
