...
def main(cfg: DictConfig) -> float:
    ...
    # Initialize MLflow
    mlflow_utils.setup_mlflow(experiment_name="redsm5-joint")
    ...
    try:
        with mlflow_run:
            ...
            train_dataset, val_dataset, test_dataset = build_joint_datasets(
                ground_truth_path=cfg.training_mode.data.ground_truth_path,
            ...
            train_config = {
                ...
                "metric_for_best_model": cfg.training_mode.get("metric_for_best_model", "combined_f1"),
...
def train_joint_model(
    ...
    scaler = None  # Using bfloat16, so no scaler needed
    best_metric = 0.0
    patience_counter = 0
