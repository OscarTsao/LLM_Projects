...
- **Base Image**: NVIDIA CUDA 12.3 with cuDNN 9 on Ubuntu 22.04 LTS
- **Python 3.11** with PyTorch Nightly (CUDA 12.1+ compatible)
...
- **Compatibility**: Works on Ubuntu 20.04 and 22.04 LTS host systems
