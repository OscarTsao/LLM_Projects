...
- **Implementation**:
  ...
  - Dataset: "RedSM5 mental health posts (<10GB), loaded from Hugging Face Hub (dataset ID: irlab-udc/redsm5, revision: main) with local cache fallback"
...
- ✅ Added threshold fields (optional):
...
- ✅ Metrics limited to evidence binding (span_f1, precision, recall, exact_match, char_f1)
...
| **III. Single-Agent Architecture** | ✅ Evidence binding only | ✅ Evidence head only | **COMPLIANT** |
