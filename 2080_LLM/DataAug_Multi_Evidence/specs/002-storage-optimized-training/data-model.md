...
This document defines the data models and entity relationships for the storage-optimized evidence-only NLP training pipeline. Models are organized by domain: HPO management, training artifacts, experiment tracking, and dataset structures.
...
# Optimization Metric
optimization_metric: str  # e.g., "val_span_f1", "val_accuracy"
...
hpo_tune_thresholds: Optional[bool]  # Whether to tune thresholds (default false)
...
# Optimization Metric
optimization_metric_name: str  # e.g., "val_span_f1"
...
#     "span_f1": float,               # Token-level F1 (span overlap)
...
- **Evidence-only NLP support**: ProcessedExample, RedSM5Annotation models handle evidence binding
