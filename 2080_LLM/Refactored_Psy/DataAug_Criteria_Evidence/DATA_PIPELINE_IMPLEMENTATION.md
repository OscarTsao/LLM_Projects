...
**Location:** `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/configs/data/field_map.yaml`

### 2. `src/psy_agents_aug/data/groundtruth.py`
...
**Location:** `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/src/psy_agents_aug/data/groundtruth.py`

### 3. `src/psy_agents_aug/data/loaders.py`
...
**Location:** `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/src/psy_agents_aug/data/loaders.py`
...
**Location:** `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/scripts/make_groundtruth.py`
...
**Locations:**
- `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/tests/test_groundtruth.py`
- `/experiment/YuNing/Refactored_Psy/DataAug_Criteria_Evidence/tests/test_loaders.py`
...
# Run with coverage
python -m pytest tests/ --cov=psy_agents_aug.data
```
...
```python
from psy_agents_aug.data.loaders import load_splits_json
...
- Package: `psy_agents_aug` (instead of `psy_agents_aug`)
...
2. `src/psy_agents_aug/data/groundtruth.py` - Groundtruth generation with strict validation
3. `src/psy_agents_aug/data/loaders.py` - Data loaders with validation
