...
from Project.Criteria.engine.train_engine import _build_model, _evaluate, _prepare_datasets
    ...
    *,
    ...
    if split == "train":
        ...
        if test_dataset is None:
            raise ValueError("Test split not available. Adjust dataset.splits to allocate test data.")
