...
class EvidenceAgent:
    ...
    def train(self, dataset, output_dir: Path, seed: Optional[int] = None, dry_run: bool = False) -> Dict[str, Any]:
        return run_training(dataset, config_path=self.config_path, output_dir=output_dir, seed=seed, dry_run=dry_run)
