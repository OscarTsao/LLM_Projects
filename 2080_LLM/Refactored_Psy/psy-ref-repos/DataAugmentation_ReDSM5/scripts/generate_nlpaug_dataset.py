#!/usr/bin/env python3
"""Generate NLPAug-only augmented dataset."""
...
from src.augmentation.nlpaug_pipeline import NLPAugAugmenter


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate NLPAug augmented dataset")
...
def main() -> None:
    ...
    augmenter = NLPAugAugmenter(config)
    output = augmenter.run()
    print(f"NLPAug dataset written to {output}")
