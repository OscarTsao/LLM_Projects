...
class Evaluator:
    ...
    def evaluate(
        ...
        probabilities = np.array(all_probabilities) if all_probabilities else np.empty((0, 0))
    ...
    def _compute_criteria_metrics(
        ...
        metrics["per_criterion_f1"] = _compute_grouped_f1(labels, predictions, criterion_ids)
